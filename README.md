...
![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello.png)
...
![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-2.png)

![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-3.png)

2. 3. Удалять карточки - при наведении на карточку появляется иконка крестик ("\E951"), которая и удаляет карточку (обратите внимание в оригинальном Trello такой операции нет, есть только архивация, но мы для упрощения её ввели):

![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-4.png)
...
![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-5.png)

2. Внешний вид в момент переноса (карточка удаляется из своего начального положения):

![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-6.png)
...
![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-7.png)
...
![](https://github.com/danroman-github/ahj-dnd/blob/main/src/img/trello-8.png)
